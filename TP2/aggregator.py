...
class Aggregator(ABC):
    ...
    def __init__(
        ...
        self.n_clients_per_round = max(1, int(self.n_clients * self.sampling_rate))
    ...
    def sample_clients(self):
        ...
        print(f"Sampled Clients: {self.sampled_clients_ids}")
...
class CentralizedAggregator(Aggregator):
    ...
    def mix(self):
        ...
        if self.sample_with_replacement:
            aggregation_weights = torch.ones(self.n_clients_per_round)
        else:
